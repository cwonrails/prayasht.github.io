...
class Emblem extends React.Component {
  ...
  render() {
    let svgEmblem = (
      <svg version="1.1" id="main" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="500px" height="500px" viewBox="0 0 500 500" enableBackground="new 0 0 500 500">
        <defs>
        ...
        <a href="http://twitter.com/iameffulgence" target="_blank">
        ...
        <a href="http://facebook.com/iameffulgence" target="_blank">
        ...
        <a href="http://medium.com/@effulgence" target="_blank">
        ...
        <Link to={"http://behance.net/effulgence"} target="_blank">
