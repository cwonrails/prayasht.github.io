    ...
    let emblem = (
      <svg id="main" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="500px" height="500px" viewBox="0 0 500 500" enableBackground="new 0 0 500 500">
        ...
        <a xlinkHref="http://youtube.com/iameffulgence" target="_blank">
          ...
          <path id="youtube-icon" fill="#FFFFFF" d="M285.401,453.441c-2.136-0.146-6.893-0.145-9.025,0
        ...
        <a xlinkHref="http://twitter.com/iameffulgence" target="_blank">
          ...
          <path id="twitter-icon" fill="#FFFFFF" d="M323.946,418.582c5.428,0,8.396-4.499,8.396-8.398c0-0.127,0-0.255-0.008-0.381
        ...
        <a xlinkHref="http://soundcloud.com/effulgence" target="_blank">
          ...
          <path id="soundcloud-icon" fill="#FFFFFF" d="M275.711,418.582h-0.755v-6.091c0.233-0.174,0.482-0.324,0.755-0.428V418.582z
      			 M277.977,418.582h0.755v-6.964c-0.173,0.2-0.335,0.414-0.47,0.647l-0.285-0.139V418.582z M276.466,418.582h0.756v-6.68
      			c-0.384-0.06-0.471-0.038-0.756-0.008V418.582z M273.446,418.582h0.755v-5.3c-0.235,0.346-0.418,0.733-0.521,1.159l-0.233-0.139
      			V418.582z M271.182,414.619c-0.457,0.412-0.755,1.021-0.755,1.711c0,0.69,0.298,1.3,0.755,1.712V414.619z M285.434,414.111
      			c-0.154-2.141-1.814-3.833-3.862-3.833c-0.771,0-1.483,0.247-2.085,0.662v7.642h6.861c1.212,0,2.197-1.052,2.197-2.345
      			C288.545,414.551,286.908,413.389,285.434,414.111z M272.691,414.092c-0.228-0.019-0.396-0.023-0.755,0.092v4.295
      			c0.337,0.108,0.48,0.104,0.755,0.104V414.092z"/>
        </a>
        ...
        <a xlinkHref="http://facebook.com/iameffulgence" target="_blank">
          ...
          <path id="facebook-icon" fill="#FFFFFF" d="M378.892,366.218h-1.021c-0.326,0-0.571,0.135-0.571,0.473v0.589h1.592l-0.127,1.592
      			h-1.466v4.248h-1.592v-4.248h-1.062v-1.592h1.062v-1.02c0-1.074,0.565-1.634,1.838-1.634h1.347V366.218z"/>
        </a>

        <a xlinkHref="http://linkedin.com/in/prayasht" target="_blank">
          ...
          <path id="linkedin-icon" fill="#FFFFFF" d="M326.202,364.923c0,0.552-0.444,0.999-0.992,0.999s-0.991-0.447-0.991-0.999
      			s0.443-1,0.991-1S326.202,364.371,326.202,364.923z M326.21,366.723h-1.999v6.396h1.999V366.723z M329.401,366.723h-1.986v6.396
      			h1.986v-3.358c0-1.866,2.411-2.02,2.411,0v3.358h1.993v-4.051c0-3.15-3.566-3.036-4.404-1.485V366.723z"/>
        </a>
        ...
        <a xlinkHref="http://behance.net/effulgence" target="_blank">
          ...
          <path id="behance-icon" fill="#FFFFFF" d="M279.016,364.708c0.396,0,0.751,0.034,1.079,0.104c0.322,0.07,0.6,0.184,0.832,0.343
