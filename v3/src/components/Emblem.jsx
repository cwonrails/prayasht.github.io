    ...
    let emblem = (
      <svg id="main" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="500px" height="500px" viewBox="0 0 500 500" enableBackground="new 0 0 500 500">
        ...
        <a xlinkHref="http://soundcloud.com/effulgence" target="_blank">
          ...
          <path id="soundcloud-icon" fill="#FFFFFF" d="M278.21,418.583h-0.608v-4.905c0.188-0.14,0.388-0.261,0.608-0.346V418.583z
        ...
        <a xlinkHref="http://instagram.com/_effulgence" target="_blank">
          ...
          <path id="insta-icon" fill="#FFFFFF" d="M329.013,364.396c1.278,0,1.431,0.005,1.937,0.028c1.3,0.06,1.906,0.677,1.967,1.966
